...
+`scale_colour_brewer()` is for points  #ex geom_point
...
homerange %>% 
  ggplot(aes(x=taxon, y=log10.mass))+
  geom_boxplot()+
  facet_grid(.~trophic.guild~thermoregulation)+#grid allows you to shape how you want it ".~" at the beginning and at the end, added in thermoregulation
  theme(axis.text.x = element_text(angle = 60, hjust=1))
```
