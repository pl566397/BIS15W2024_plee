...
## Resources  
- [ggplot2 cheatsheet](https://posit.co/resources/cheatsheets/)  #gg means grammar of graphics
...
In short, **plot= data + geom_ + aesthetics**.  #geom is plot type
...
homerange %>% 
  ...
  count(trophic.guild) %>% #this way allows you to have count
