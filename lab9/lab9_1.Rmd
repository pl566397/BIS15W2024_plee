...
---
##Group Project
#look at research papers for data, pick data I can understand, find data that have a mix of categorical and continous variables
#Find data that'll tell you a story, meaning to the data, don't think outside the box
...
It is untidy because the colunms are observations. 
3. Use `pivot_longer()` to make the data tidy.  #R needs the data to be like this in order to plot
```{r}
relig_income %>% 
