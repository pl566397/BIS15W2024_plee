...
heartrate2 #you have name and sex together that you have to separate
```
...
heartrate3 <- heartrate2 %>% 
  separate(patient, into=c("patient", "sex"), sep="_") %>% #separate patient from sex
...
```{r}
tb_data %>% 
  pivot_wider(names_from = "key", #the observations under key will become new columns, new columns are cases and population
