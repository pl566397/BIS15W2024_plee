...
shinyApp(ui, server)#shinyapp won't knit, we can't knit our homework
```
...
ui <- fluidPage(
    ...
    plotOutput("plot", width = "500px", height = "400px")#slider input
)
...
ui <- dashboardPage(
  ...
  dashboardSidebar(),
  dashboardBody()
)#this creates a dashboard for you
...
shinyApp(ui, server) #ui controls how app looks
```
...
ui <- dashboardPage(
  ...
  dashboardBody(
  fluidRow(
  box(width=3,#width makes the box smaller #organize select variable sina box on the app
...
box(#organizes the plot in a box in the app
  plotOutput("plot", width = "500px", height = "400px")
